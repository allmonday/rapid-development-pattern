        ...
        <q-card v-if="page" flat bordered class="q-mb-xs">
            ...
            <q-card-section v-if="page.team" class="q-pa-sm q-pt-none">
                ...
                <q-card flat bordered class="bg-grey-1">
                    ...
                    <q-card-section v-if="page.team.sprints && page.team.sprints.length > 0" class="q-pa-xs q-pt-none">
                        <div class="text-caption q-mb-xs">Sprints ({{ page.team.sprints.length }})</div>
                        <q-card v-for="sprint in page.team.sprints" :key="sprint.id" flat bordered class="q-mb-xs q-ml-sm bg-grey-2">
                            <q-card-section class="q-pa-xs">
