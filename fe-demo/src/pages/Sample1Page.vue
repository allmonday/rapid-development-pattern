        ...
        >
          <q-card-section class="q-pa-sm">
            <div class="row items-center no-wrap">
              ...
              <div v-if="task.user" class="text-caption text-primary">
                {{ task.user.name }}
              </div>
            </div>
          </q-card-section>
        ...
        >
          <q-card-section class="q-pa-sm">
            <div class="row items-center no-wrap">
              ...
              <div v-if="story.owner" class="text-caption text-primary">
          ...
          <q-card-section
            v-if="story.tasks && story.tasks.length > 0"
            ...
            >
              <q-card-section class="q-pa-xs">
                <div class="row items-center no-wrap">
                  ...
                  <q-space />
                  <div v-if="sprint.stories" class="text-caption text-grey">
